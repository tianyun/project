...
import com.autumn.baseAdapter.BaseAdapterActivity;
import com.autumn.ble.BleScan;
import com.autumn.fragment.ContainerActivity;
import com.autumn.gridview.GridViewActivity;
import com.autumn.handler.HandlerActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonHandler = findViewById(R.id.btn_handler);
        ...
        Button buttonAdapter = findViewById(R.id.btn_adapter);
        ...
        Button btnBleScan = findViewById(R.id.btn_ble_scan);
        btnBleScan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //跳转到蓝牙扫描
                Intent intent = new Intent(MainActivity.this, BleScan.class);
                startActivity(intent);
